...
FREE=(demo.sh demo_postmaster.sh demo_research.sh demo_multihost.sh demo_security.sh \
      demo_federation.sh demo_dlq.sh demo_terminal.sh a2a_demo.sh demo_a2a_secure.sh demo_a2a_push.sh demo_signed_card.sh demo_hardened.sh demo_invite.sh demo_tls.sh demo_up.sh \
      demo_herdr.sh)
